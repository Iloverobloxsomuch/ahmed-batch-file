...
title ahmed.exe
color B
echo thank you for downloading ahmed.exe
ping n- 2 127.0.0.1>nul
echo Because you have made download i get access to everything
ping n- 2 127.0.0.1>nul
echo So..... thanks bro :D
ping n- 2 127.0.0.1>nul
echo Would you like me to stop?
echo Type Yes or No
set input=
set /p input=
if %input%== Yes goto 1
...
:2
Cls
echo would you like to use your anti-malware software?
...
Cls
color C
echo Oh well. I already deleted it
echo WARNING: ILLEGAL ADWARE DETECTED
ping n- 2 127.0.0.1>nul
ping n- 2 127.0.0.1>nul
goto 1
:4
Cls
color C
echo DOWNLOADING VIRUS... 1%
ping n- 2 127.0.0.1>nul
ping n- 2 127.0.0.1>nul
ping n- 2 127.0.0.1>nul
echo DOWNLOADING VIRUS... 37%
echo DOWNLOADING VIRUS... 43%
ping n- 2 127.0.0.1>nul
echo Error.exe
ping n- 2 127.0.0.1>nul
echo @*#@(&#(*$&@)(&*)&)(*&@#^)&#&y48y874y837yY*@&YynN&KJHBy7#*&2@*(J@U(2n2908unhehn9qhr98c7r893Y*Y*H2&y(*&YNW@H(*yw*@BN*(HNIDG2
echo =!WARNING!=
